...
$sql = "SELECT * FROM productos WHERE categoria = 'confites y gomitas'";
...
<head>
    ...
    <title>Confites y Gomitas</title>
...
<body>
    ...
    <section id="menu" class="dropdown-content">
        ...
        <ul>
            ...
            <li><a href="#" id="link">Confites y gomitas</a></li>
